...
*cd "C:\Users\wb553190\Dropbox\WB_DRC_Eastern_Recovery\13_endline\02_Thimo Ruraux\07_Data (prestest, pilote, end)\Data of pilote"
	...
	*import excel using "$home/14. Female Entrepreneurship Add on/Survey Instrument/DIME_Tunisia_entrepreneurship_12232020_Encrypted Version.xlsx", sheet("survey") clear first
	...
	import excel using "ThimoRuraux_endline_field_03212021.xlsx", sheet("survey") clear first 
...
*/	
	...
	* Export to excel
	...
	u "Statistiques.dta", clear

	merge 1:1 Variables using "form.dta"
	...
	export excel using "Data Quality.xlsx", sheet("Stat", replace) first(var)
